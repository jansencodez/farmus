...
import { View, Text, StyleSheet, Switch, Pressable, StyleProp, ViewStyle, TextStyle } from 'react-native';
...
const NotificationSettingsScreen: React.FC = () => {
  ...
  const handleSaveSettings = () => {
    ...
    console.log('Settings saved:', { notificationsEnabled, emailNotifications, pushNotifications });
  };
    ...
    <SafeAreaProvider>
      <SafeAreaView style={getContainerStyle()}>
        ...
        <View style={styles.section}>
          <Text style={getTextStyle(theme === 'dark')}>Enable Notifications</Text>
          <Switch
        ...
        {notificationsEnabled && (
          <>
            <View style={styles.section}>
              <Text style={getTextStyle(theme === 'dark')}>Email Notifications</Text>
              <Switch
            ...
            <View style={styles.section}>
              <Text style={getTextStyle(theme === 'dark')}>Push Notifications</Text>
              <Switch
        ...
        <Pressable style={[styles.button, theme === 'dark' ? styles.darkButton : styles.lightButton]} onPress={handleSaveSettings}>
